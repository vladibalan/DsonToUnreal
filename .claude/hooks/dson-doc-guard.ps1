...
- Point, don't duplicate: if another doc owns a fact, link it by name (the R1-R12 list and the Director/Implementer role model each have exactly one home).
